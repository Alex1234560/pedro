...
public class Coordinates {
    ...
    public static double GOAL_Y = 144;//141

    public static double GOAL_Y_WHEN_AT_TOP_OF_FIELD = 135;
    public static double GOAL_X_WHEN_AT_BOTTOM_OF_FIELD = 2.5; // i found 0 to be better try on field.
