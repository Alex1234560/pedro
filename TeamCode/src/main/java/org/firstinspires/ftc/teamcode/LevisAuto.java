...
@Configurable
@Autonomous
public class LevisAuto extends OpMode {
...
//    private static final double GOAL_Y = 132;
    ...
    private static  Pose shootPos,shootPos180,intakeStart,intakeEnd,driveToPark,currentPose;
    ...
    public void statePathUpdate() {
        if (autoTimer.getElapsedTimeSeconds() > 28){
        ...
        switch(pathState) {
            ...
            case AUTOPARK:
                ...
                driveToPark = new Pose(xFlip(40, IsRed),  60, Math.toRadians(angleFlip(180, IsRed)));
