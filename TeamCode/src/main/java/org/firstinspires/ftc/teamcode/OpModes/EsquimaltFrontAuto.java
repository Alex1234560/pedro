...
@Configurable
@Autonomous
public class EsquimaltFrontAuto extends OpMode {
    ...
    private static Pose EmptyClassifierPosTopLine,EmptyClassifierPosMiddleLine,EmptyClassifierControlPointMiddleLine,EmptyClassifierControlPointTopLine;
    private static Pose EmptyClassPos,EmptyClassPosControlPoint;
...
//                        setPathState(PathState.CLEAR_CLASSIFIER);
//                    }
                    if (loop_times==1 ){setPathState(PathState.CLEAR_CLASSIFIER);}
                    else if (loop_times==2 ){setPathState(PathState.CLEAR_CLASSIFIER);}
                    else {
...
//                        }
                        if (loop_times == 1){
                            ...
                            EmptyClassifierControlPoint = EmptyClassifierControlPointMiddleLine;
                            EmptyClassifierPos = EmptyClassifierPosMiddleLine;
                        }
                        if (loop_times == 2){
    ...
    public void start() {
        ...
        EmptyClassifierPos = EmptyClassifierPosTopLine;
        EmptyClassifierControlPoint = EmptyClassifierControlPointTopLine;
    ...
    private void buildPoses(){
        ...
        EmptyClassifierPosTopLine = new Pose(Cords.xFlip(15, IsRed), 76.4740834386852, Math.toRadians(Cords.angleFlip(90, IsRed)));
        EmptyClassifierControlPointTopLine = new Pose(Cords.xFlip(24.25, IsRed), 80);

        EmptyClassifierPosMiddleLine = new Pose(Cords.xFlip(15, IsRed), 76.4740834386852, Math.toRadians(Cords.angleFlip(270, IsRed)));
        EmptyClassifierControlPointMiddleLine = new Pose(Cords.xFlip(22.611567635903917,IsRed), 60.82806573957017);
